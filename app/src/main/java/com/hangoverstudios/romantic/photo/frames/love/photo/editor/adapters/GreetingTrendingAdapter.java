...
public class GreetingTrendingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GreetingTrendingAdapter(ArrayList<Object> mData, Context CONTEXT, int type) {
        this.mData = mData;
        this.mContext = CONTEXT;
        this.type = type;
        if(DataHolder.getDataHolder().getGreetingTrendList() != null) {
            downloadList = DataHolder.getDataHolder().getGreetingTrendList();
        }
    }
    @Override
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, final int position) {
        ...
        Log.v("MY_TAG","paths : "+mData.get(position).toString());
        ...
        switch (viewType) {
            ...
            case STRING:
                ...
                if(position < downloadList.size() && downloadList.get(position) != null) {
                        ...
                        public void onClick(View view) {
                            if(finalMediaStorageDir != null) {
                                if (!finalMediaStorageDir.exists()) {
                                    ...
                                    mContext.startActivity(new Intent(mContext, GreetingEditActivity.class)
                                            .putExtra("PATH", downloadList.get(position).toString())
                                            .putExtra("FROM", "Trending_Greeting"));
