...
public class DoubleTrendingFrameAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DoubleTrendingFrameAdapter(ArrayList<Object> mData, Context CONTEXT, int type) {
        this.mData = mData;
        this.mContext = CONTEXT;
        this.type = type;
        if (DataHolder.getDataHolder().getDoubleTrendingFramesList() != null) {
            downloadList = DataHolder.getDataHolder().getDoubleTrendingFramesList();
        }
    }
                        ...
                        public void onClick(View view) {
                            if (finalMediaStorageDir != null) {
                                if (!finalMediaStorageDir.exists()) {
                                    ...
                                    bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE,   "doublelove/trending/" + paths[paths.length - 1]);
