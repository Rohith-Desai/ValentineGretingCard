...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
 //   private static final String AD_UNIT_ID = "ca-app-pub-3940256099942544/341983529";
   private static final String AD_UNIT_ID = "ca-app-pub-9569880823887785/6286044853";
    ...
    public void fetchAd() {
        if (!isAdAvailable()) {
            ...
            AppOpenAd.load((Context) this.myApplication, AD_UNIT_ID, adRequest, 1, this.loadCallback);
        }
    }
