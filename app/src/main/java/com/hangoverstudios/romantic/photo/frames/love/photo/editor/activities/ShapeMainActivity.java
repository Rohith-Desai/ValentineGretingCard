...
public class ShapeMainActivity extends AppCompatActivity {
    ...
    CardView shape_frames, shape_trending_frames;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shape_frames = findViewById(R.id.shape_frames);
        shape_trending_frames = findViewById(R.id.shape_trending_frames);
        myClickAnim(this,shape_frames);
        myClickAnim(this,shape_trending_frames);

        shape_frames.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ShapeMainActivity.this, ShapeListActivity.class);
                startActivity(i);
            }
        });

        shape_trending_frames.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ShapeMainActivity.this, ShapeListActivity.class);
                startActivity(i);
        ...
        adContainerView = findViewById(R.id.admob_banner_shapeMain);
        ...
        builder.forNativeAd(
                new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        if (ShapeMainActivity.this.nativeAd != null) {
                            ShapeMainActivity.this.nativeAd.destroy();
                        }
                        ShapeMainActivity.this.nativeAd = nativeAd;
                        FrameLayout frameLayout = findViewById(R.id.native_ad_shapeMain);
                        NativeAdView adView =
