...
public class ShapesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShapesAdapter(ArrayList<Object> mData, Context CONTEXT, int type) {
        this.mData = mData;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, final int position) {
        ...
        switch (viewType) {
            ...
            case STRING:
                ...
                final String img1 = mData.get(position).toString();
                    ...
                    public void onClick(View view) {
                        if(finalMediaStorageDir != null) {
                            if (!finalMediaStorageDir.exists()) {
                                showDownLoadDialog(mData.get(position).toString(), holder, position);
                            } else {
                                mContext.startActivity(new Intent(mContext, SingleFrameEditActivity.class)
                                        .putExtra("PATH", mData.get(position).toString())
                                        .putExtra("FROM", "Shapes"));
                            }
                        }
                    }
                });
